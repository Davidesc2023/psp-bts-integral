...
const chartDataMock = [
  { mes: 'Oct', registros: 42, adherencia: 78 },
  { mes: 'Nov', registros: 55, adherencia: 82 },
  { mes: 'Dic', registros: 48, adherencia: 79 },
  { mes: 'Ene', registros: 61, adherencia: 85 },
  { mes: 'Feb', registros: 57, adherencia: 88 },
  { mes: 'Mar', registros: 63, adherencia: 91 },
];
  ...
  const kpis = [
    {
      ...
      value: datosReporte.length,
      color: '#0E7490',
      bg: '#E0F2FE',
    },
    { label: '% Adherencia', value: '88%', color: '#166534', bg: '#DCFCE7' },
    { label: 'Pacientes Activos', value: 7, color: '#7C3AED', bg: '#EDE9FE' },
    {
      label: 'Período',
