...
import { Edit, Check, Close, Dashboard } from '@mui/icons-material';
import {
  Schedule,
  LocalShipping,
  Vaccines,
...
export const PacienteTabs = ({ patient, onEdit }: PacienteTabsProps) => {
  ...
  return (
    <Box>
      ...
      >
        <Tab label="Vista 360°" icon={<Dashboard sx={{ fontSize: 18 }} />} iconPosition="start" />
      ...
      <TabPanel value={tab} index={2}>
        <Box sx={{ display: 'flex', justifyContent: 'flex-end', mb: 2 }}>
          <Button size="small" variant="contained" onClick={() => navigate(`/followups?patientId=${patient.id}`)}>
            + Nuevo Seguimiento
          </Button>
        </Box>
      ...
      <TabPanel value={tab} index={3}>
        <Box sx={{ display: 'flex', justifyContent: 'flex-end', mb: 2 }}>
          <Button size="small" variant="contained" onClick={() => navigate(`/prescriptions?patientId=${patient.id}`)}>
            + Nueva Prescripción
          </Button>
        </Box>
      ...
      <TabPanel value={tab} index={4}>
        <Box sx={{ display: 'flex', justifyContent: 'flex-end', mb: 2 }}>
          <Button size="small" variant="contained" onClick={() => navigate(`/deliveries?patientId=${patient.id}`)}>
            + Nueva Entrega
          </Button>
        </Box>
      ...
      <TabPanel value={tab} index={6}>
        <Box sx={{ display: 'flex', justifyContent: 'flex-end', mb: 2 }}>
          <Button size="small" variant="contained" color="error" onClick={() => navigate(`/barriers?patientId=${patient.id}`)}>
            + Nueva Barrera
          </Button>
        </Box>
