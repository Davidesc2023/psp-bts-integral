...
const ESTADO_BACKEND_TO_DISPLAY: Record<string, ServicioEstado> = {
  PENDIENTE: 'PENDIENTE',
  PROGRAMADO: 'ACTIVO',
  COMPLETADO: 'CERRADO_EFECTIVO',
  CANCELADO: 'CANCELADO',
};
...
function mapApiToServicio(sc: ServicioComplementarioType): Servicio {
  ...
  const estadoMapped = ESTADO_BACKEND_TO_DISPLAY[sc.estadoServicio] ?? 'PENDIENTE';
  return {
    id: sc.id,
